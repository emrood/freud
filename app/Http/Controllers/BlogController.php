...
class BlogController extends Controller
{
    ...
    public function show(Request $request)
    {
        if(auth()->user()->permissions()->where('name','=','view-blog')->first()!= null) {
            ...
            return view('backend.blog.show', compact('blog', 'comments', 'tags'));
        }
        return response(view('403'), 403);
    }
    ...
    public function edit(Request $request)
    {
        if(auth()->user()->permissions()->where('name','=','edit-blog')->first()!= null) {
            ...
            return view('backend.blog.edit', compact('blog', 'blogcategory','tags'));
        }
        return response(view('403'), 403);
    }
    ...
    public function getCategoryBlog($slug){
        ...
        if($category != null){
            return view('blog.category-blogs', compact('blogs','category'));
        }else{
            return response(view(404),404);
        }
    }
    ...
    public function getTagBlog($slug){
        ...
        if($tag != null){
            ...
            return view('blog.tag-blogs', compact('blogs', 'tag'));
        }else{
            return response(view(404),404);
        }
    }
    ...
    public function getAuthorBlog($id){
        ...
        if($author != null){
            ...
            return view('blog.author-blogs', compact('blogs', 'author'));
        }else{
            return response(view(404),404);
        }
    }
