...
@section('title') {{ 'Edit Blog | '.env('APP_NAME') }} @endsection

@section('breadcrumbs')
    @include('backend.layouts.partials.breadcrumbs',['current' => 'Edit Blog'])
@endsection
                        ...
                        @can('edit-blog')
                            <div class="row justify-content-center">
                                <div class="col-12 align-content-center">
                                    <form class="form-horizontal mt-3" enctype="multipart/form-data" method="post"
                                          action="{{url('blog/edit/'.$blog->id)}}">
                                        {{csrf_field()}}
                                            ...
                                            <div class="col-sm-4 {{ $errors->first('blog_category_id', 'has-error') }}">
                                                ...
                                                <select class="form-control" name="blog_category_id">
                                                    ...
                                                    @foreach($blogcategory as $item)
                                                        <option @if($item->id == $blog->blog_category_id) selected
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-8">
                                                <input type="text" class="form-control" value="{{ $tags }}"
                                                       data-role="tagsinput" placeholder="Add tags here" name="tags">
                                            </div>
