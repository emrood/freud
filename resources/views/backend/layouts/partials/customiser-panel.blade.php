        ...
        <div class="tab-content" id="pills-tabContent">
            ...
            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                <div class="p-15 border-bottom">
                    <!-- Sidebar -->
                    <h5 class="font-medium m-b-10 m-t-10">Layout Type</h5>
                    <ul class="theme-color">
                        <li class="@if(session()->get('theme-layout') == 'normal') active @endif"><a href="{{asset('?theme=normal')}}" class="theme-link">Normal Layout</a></li>
                        <li class="@if(session()->get('theme-layout') == 'fix-header') active @endif"><a href="{{asset('?theme=fix-header')}}" class="theme-link">Top Header</a></li>
                        <li class="@if(session()->get('theme-layout') == 'mini-sidebar') active @endif "><a href="{{asset('?theme=mini-sidebar')}}" class="theme-link">Mini-sidebar</a></li>
                    </ul>
                </div>
                <div class="p-15 border-bottom">
                    <!-- Sidebar -->
                    ...
                    <li>
                        <div class="message-center chat-scroll">
                            <a href="javascript:void(0)" class="message-item" id='chat_user_1' data-user-id='1'>
                                    <span class="user-img"> <img src="https://via.placeholder.com/52x52?text=User" alt="user" class="rounded-circle">
            ...
            <div class="tab-pane fade p-15" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                ...
                <div class="steamline">
                    ...
                    <div class="sl-item">
                        <div class="sl-left"> <img class="rounded-circle" alt="user" src="https://via.placeholder.com/52x52?text=User">
                        </div>
                        <div class="sl-right">
