    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        <div class="navbar-header">
            ...
            <div class="navbar-brand">
                <a href="{{asset('/main/main')}}" class="logo">
                    <!-- Logo icon -->
                    <b class="logo-icon">
                    ...
                    <span class="logo-text">
                        ...
                        <!-- Light Logo text -->
                                ...
                                <span style="color: white;">Go-Tech</span>
                            </span>
                </a>
        ...
        <div class="navbar-collapse collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav float-right">
                ...
                <li class="nav-item dropdown">
                    @if(auth()->check())
                        ...
                        <div class="dropdown-menu dropdown-menu-right user-dd animated flipInY">
                            ...
                            <div class="profile-dis scrollable">
                                <a class="dropdown-item" href="{{asset('/main/main')}}">
                                    <i class="fas fa-home mx-1"></i> Tableau de bord</a>
                                ...
                                <a class="dropdown-item" href="{{asset('account-settings')}}">
                                    <i class="ti-settings mx-1"></i>Paramètre du compte</a>
                                <div class="dropdown-divider"></div>
                    ...
                    @else
                        <a class="nav-link waves-effect waves-dark pro-pic" href="{{asset('login')}}">Se econnecter</a>
                    @endif
                </li>
                <!-- ============================================================== -->
                <!-- User profile and search -->
