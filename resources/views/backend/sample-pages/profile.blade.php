...
@section('title') {{ 'Profile Page | '.env('APP_NAME') }} @endsection

@section('breadcrumbs')
    @include('backend.layouts.partials.breadcrumbs',['current' => 'Profile Page'])
@endsection
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="https://via.placeholder.com/600x600?text=user" class="rounded-circle"
                                                     width="150" />
                        ...
                        <div class="tab-pane fade show active" id="current-month" role="tabpanel"
                            ...
                            <div class="card-body">
                                <div class="profiletimeline m-t-0">
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="https://via.placeholder.com/52x52?text=user" alt="user"
                                        ...
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span
                                                ...
                                                <p>assign a new task <a href="javascript:void(0)"> Design
                                                        weblayout</a></p>
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 m-b-20"><img src="https://via.placeholder.com/890x593?text=Image"
                                        ...
                                        <div class="sl-right">
                                            <div> <a href="javascript:void(0)" class="link">John Doe</a> <span
                                                ...
                                                <div class="m-t-20 row">
                                                    <div class="col-md-3 col-xs-12"><img src=" https://via.placeholder.com/890x593?text=Image"
                                    ...
                                    <hr>
                                    <div class="sl-item">
                                        <div class="sl-left"> <img src="https://via.placeholder.com/600x600?text=user" alt="user"
                                                                   class="rounded-circle" /> </div>
                                        <div class="sl-right">
                                            <div><a href="javascript:void(0)" class="link">John Doe</a> <span
                                                        class="sl-date">5 minutes ago</span>
