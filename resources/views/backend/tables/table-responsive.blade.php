                ...
                <div class="col-12">
                            ...
                            <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe"
                                ...
                                <tr>
                                    ...
                                    <th scope="col" data-tablesaw-sortable-col
                                        data-tablesaw-sortable-default-col data-tablesaw-priority="3">Rank</th>
                                ...
                                <tr>
                                    <td class="title"><a class="link" href="javascript:void(0)">Harry Potter
                                            and the Deathly Hallows—Part 2</a></td>
                                    <td>4</td>
                                    <td>2011</td>
                                    <td>96%</td>
                                    <td>$1.3B</td>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h5 class="card-subtitle">The Column Swipe Table allows the user to select which
                                columns they want to be visible.</h5>
                            <table class="tablesaw table-bordered table-hover table" data-tablesaw-mode="swipe">
                                <thead>
                                <tr>
