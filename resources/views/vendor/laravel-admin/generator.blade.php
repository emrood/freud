...
@section('title') {{ 'CRUD Generator | '.env('APP_NAME') }} @endsection


@section('breadcrumbs')
    @include('backend.layouts.partials.breadcrumbs',['current' => 'CRUD Generator'])
@endsection


@push('after-css')
    <link rel="stylesheet" href="{{url('assets/libs/bootstrap-select/bootstrap-select.min.css')}}">
    <link rel="stylesheet" href="{{url('assets/libs/fontawesome-iconpicker/fontawesome-iconpicker.min.css')}}">
    <style>
...
@push('js')
    <script src="{{url('assets/libs/fontawesome-iconpicker/fontawesome-iconpicker.min.js')}}"></script>
